...
const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
    ...
    backgroundImageUrl = "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1920",
    navLinks = [
    ...
    return (
        <section className="w-full isolate min-h-screen overflow-hidden relative">
            ...
            />
            <div className="pointer-events-none absolute inset-0 bg-neutral-950/80 -z-10" />
                    ...
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <div className="flex flex-col sm:flex-row sm:gap-4 mt-10 gap-3 items-center justify-center animate-fade-slide-in-4">
                            <a
                                ...
                                className="inline-flex items-center gap-2 hover:bg-white/15 text-sm font-medium text-white bg-white/10 ring-white/15 ring-1 rounded-full py-3 px-5 font-sans transition-colors animate-pulse-slow"
                            >
                                {primaryButtonText}
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4">
                                    <path d="M5 12h14" />
